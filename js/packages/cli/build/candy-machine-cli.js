...
programCommand('update_candy_machine')
    ...
    .option('-r, --rpc-url <string>', 'custom rpc url since this is a heavy command')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, date, rpcUrl, price, cacheName, cacheContent, secondsSinceEpoch, lamports, walletKeyPair, anchorProgram, candyMachine, tx;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = cmd.opts(), keypair = _a.keypair, env = _a.env, date = _a.date, rpcUrl = _a.rpcUrl, price = _a.price, cacheName = _a.cacheName;
                cacheContent = cache_1.loadCache(cacheName, env);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                cacheContent = cache_1.loadCache(cacheName, env);
                configAddress = new web3_js_1.PublicKey(cacheContent.program.config);
                return [4 /*yield*/, mint_1.mint(keypair, env, configAddress, rpcUrl)];
            case 1:
                tx = _b.sent();
